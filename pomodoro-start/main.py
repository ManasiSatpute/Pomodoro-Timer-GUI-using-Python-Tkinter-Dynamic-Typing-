...
def start_timer():
     ...
     if reps% 8==0:
          ...
          title.config(text = "Long Break" , fg=GREEN  , bg =YELLOW, font=(FONT_NAME , 35 , "bold"))

          
     elif reps% 2==0:
           count_down(short_break_sec)
           title.config(text = "Short Break" , fg=PINK  , bg =YELLOW, font=(FONT_NAME , 35 , "bold"))

     
     else:
          count_down(work_sec)
          title.config (text = "Work" , fg=RED  , bg =YELLOW, font=(FONT_NAME , 35 , "bold"))
